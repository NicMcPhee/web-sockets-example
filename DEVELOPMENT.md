...
In addition to these automated server tests, you might want to manually explore the requests and different parameters at the API level. To see what is happening and explore your API, you can use [Thunder Client](https://www.thunderclient.com/). There are more instructions about how to do this in [Lab 2](https://github.com/UMM-CSci-3601/3601-lab2_client-server/blob/main/LABTASKS.md#use-thunder-client-to-explore-api-output).
